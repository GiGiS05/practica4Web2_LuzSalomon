...
export const ExpenseForm = () => {
    ...
    return (
        <form className="space-y-5" onSubmit={handleSubmit}>
            {state.editingId? <legend className="uppercase text-center text-2xl font-black border-b-4 border-blue-500 py-2">
                Guardar cambios
            </legend>:<legend className="uppercase text-center text-2xl font-black border-b-4 border-blue-500 py-2">
                Nuevo gasto
            </legend>}
